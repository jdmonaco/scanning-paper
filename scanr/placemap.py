# encoding: utf-8
"""
scanr.placemap -- Compute place map information from circle-track session data
...
# Library imports
import numpy as np
from traits.api import HasTraits, Trait, Instance, Array, Float, Int
...
class CirclePlaceMap(TraitedArrayContainer):
    ...
    Model simulation results in the form of a completed OIRateModel (or
    subclass) object or OISessionData object, or actual recording data stored
    as a SessionData object can be used to initialize a CirclePlaceMap.
    """
    ...
    Map = Array
    angle = Array
    data = Trait(None, Instance(SessionData))
